...
> **Management pages:** if embedding stats in a pagecode-protected management page, use `c.stats` from the Clawpage JS SDK — see `the `use-sdk` skill`. Raw `fetch('/api/stats/...')` in page JS is forbidden.
